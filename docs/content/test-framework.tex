...
Overall grouped bar chart diagram (availability, relative MUT, rel MDT, rel MTBF, successful jobs percent)
...
Spider chart of each fault profiles

TODO

\begin{itemize}
	\item none profile should be all 1-s, or close to it (explain why not exactly 1)
	\item reveal possible  directions to improve the results (details in Enhancements chapter) - goal is radius 1 on all 5 axis
\end{itemize}
